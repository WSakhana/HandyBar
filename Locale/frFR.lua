...
------------------------------------------------------------------------
L["HandyBar"] = "HandyBar"
L["ADDON_DESC"] = "|cff00ccffHandyBar|r suit les cooldowns ennemis d'arène avec des barres configurables.\nLa détection automatique peut lancer les cooldowns à partir des casts ennemis et des buffs majeurs visibles.\nLe clic gauche reste disponible pour un départ manuel, et le clic droit réinitialise le cooldown.\n"
L["General"] = "Général"
L["Bars"] = "Barres"
...
L["Automatic Enemy Cooldown Detection"] = "Détection automatique des cooldowns ennemis"
L["AUTO_ENEMY_CD_DESC"] = "Démarre automatiquement les cooldowns ennemis suivis en arène en utilisant uniquement des événements Blizzard publics.\n\nLe module écoute les casts ennemis et les buffs visibles marqués BIG_DEFENSIVE, EXTERNAL_DEFENSIVE ou IMPORTANT.\nLe clic manuel reste disponible."
L["Show Only Auto-Trackable Spells"] = "Afficher uniquement les sorts AutoTrack"
L["SHOW_ONLY_AUTOTRACK_DESC"] = "Limiter les listes de sorts des barres et les icônes visibles aux sorts couverts par les règles AutoTrack de MajorCooldowns.\n\nLes sorts déjà activés mais non auto-trackables restent sauvegardés, mais sont masqués tant que cette option est activée."
...
L["Icon Tooltips"] = "Infobulles des icônes"
L["ICON_TOOLTIPS_DESC"] = "Afficher une infobulle au survol des icônes de sorts."
...
L["Edit Custom Spell"] = "Modifier le sort personnalisé"
L["Edit"] = "Modifier"
L["Editing"] = "Modification"
L["Save Changes"] = "Enregistrer"
L["Cancel"] = "Annuler"
L["Remove"] = "Supprimer"
L["REMOVE_CUSTOM_CONFIRM"] = "Supprimer le sort personnalisé '%s' ?"
L["CUSTOM_ADDED"] = "Sort personnalisé '|cff00ff00%s|r' (ID : %d) ajouté."
L["CUSTOM_UPDATED"] = "Sort personnalisé '|cff00ccff%s|r' (ID : %d) mis à jour."
...
L["TOOLTIP_CHARGES"] = "Charges : %d"
L["TOOLTIP_CD_OVERRIDE"] = "|cffFFAA00Cooldown : %ds|r |cff888888(défaut : %ds)|r"
L["TOOLTIP_SPEC_FORMAT"] = "%s - %s"
L["TOOLTIP_OVERRIDE_ACTIVE"] = "|cffFFAA00Override actif|r"
L["TOOLTIP_REMAINING"] = "Restant : %s"
L["Arena Slot: %d"] = "Slot d'arène : %d"
