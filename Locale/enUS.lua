...
------------------------------------------------------------------------
L["HandyBar"] = "HandyBar"
L["ADDON_DESC"] = "|cff00ccffHandyBar|r tracks enemy arena cooldowns with configurable bars.\nAutomatic detection can start cooldowns from enemy arena casts and visible major buffs.\nLeft-click still starts a cooldown manually, and right-click resets it.\n"
L["General"] = "General"
L["Bars"] = "Bars"
...
L["Automatic Enemy Cooldown Detection"] = "Automatic Enemy Cooldown Detection"
L["AUTO_ENEMY_CD_DESC"] = "Automatically start tracked enemy cooldowns in arena from public Blizzard events only.\n\nThis listens to enemy arena casts and visible buffs flagged as BIG_DEFENSIVE, EXTERNAL_DEFENSIVE, or IMPORTANT.\nManual clicks remain available."
L["Show Only Auto-Trackable Spells"] = "Show Only Auto-Trackable Spells"
L["SHOW_ONLY_AUTOTRACK_DESC"] = "Limit bar spell lists and visible bar icons to spells covered by MajorCooldowns AutoTrack rules.\n\nEnabled spells that are not auto-trackable stay saved, but are hidden until this option is turned off."
